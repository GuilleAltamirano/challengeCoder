...
export const postProductsValidations = async (data) => {
    ...
    if (prod.length !== 0) {throw new ApiError(`This code ${data.code} existing`, 406)}
    ...
    if ((typeof description !== 'string') || (!description) || (description.length < 10)) {throw new ApiError(`Description ${description} type is not valid`, 400)}
